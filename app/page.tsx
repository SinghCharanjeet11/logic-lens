...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-indigo-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      {/* Navbar */}
      <header className="sticky top-0 z-50 w-full" role="banner">
        <div className="mx-auto max-w-7xl px-4 md:px-6 pt-3">
          <nav className="relative flex items-center justify-between gap-4 rounded-2xl bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl backdrop-saturate-150 border border-white/50 dark:border-slate-700/50 shadow-[0_2px_16px_rgba(0,0,0,0.06)] dark:shadow-[0_2px_16px_rgba(0,0,0,0.3)] px-4 md:px-6 py-3">
            ...
            <div className="hidden lg:flex items-center gap-1" aria-label="Main navigation">
              <Link
                href="/"
                className="px-3.5 py-2 rounded-xl text-sm font-medium text-slate-900 dark:text-white bg-slate-100/80 dark:bg-slate-800/80 transition-all duration-200"
              >
                Home
              </Link>
              <a
                href="#how-it-works"
                className="px-3.5 py-2 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-200"
              >
                How It Works
              </a>
              <a
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="hidden md:flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-200"
              ...
              <button
                ...
                className="lg:hidden w-9 h-9 flex items-center justify-center rounded-xl text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 transition-all"
            ...
            {mobileMenuOpen && (
              <div className="absolute top-full left-0 right-0 mt-2 mx-0 bg-white dark:bg-slate-900 backdrop-blur-2xl rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xl shadow-slate-200/40 dark:shadow-slate-900/60 p-4 lg:hidden animate-fade-in z-50">
                <div className="flex flex-col gap-1">
                  <Link
                    href="/"
                    className="px-4 py-3 rounded-xl text-sm font-medium text-slate-900 dark:text-white bg-slate-50 dark:bg-slate-800 transition-colors"
                  ...
                  <a
                    href="#how-it-works"
                    className="px-4 py-3 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    How It Works
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-3 rounded-xl text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center gap-2"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" />
      ...
      <section className="py-20 md:py-28 text-center px-4" aria-labelledby="hero-heading">
        <div className="container mx-auto max-w-4xl">
          <div className="animate-fade-in-up">
            <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 rounded-full text-xs font-semibold tracking-wide mb-6 border border-indigo-100 dark:border-indigo-800">
          ...
          <h1 id="hero-heading" className="text-4xl md:text-6xl font-bold mb-6 text-gray-900 dark:text-white leading-tight animate-fade-in-up" style={{ animationDelay: '80ms' }}>
            Stop Guessing.
            <br />
          ...
          <p className="text-lg md:text-xl text-slate-500 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '160ms' }}>
      ...
      <section id="features" className="py-16 md:py-20 px-4" aria-labelledby="value-props-heading">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 stagger-children">
            {/* Card 1 */}
            <article className="bg-white dark:bg-slate-900 p-8 rounded-2xl border-2 border-gray-100 dark:border-slate-800 hover:border-indigo-200 dark:hover:border-indigo-700 hover:-translate-y-1 transition-all duration-300 hover:shadow-lg focus-within:border-indigo-300 focus-within:shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-950 dark:to-indigo-900 rounded-xl flex items-center justify-center mb-5" aria-hidden="true">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Diagnose First</h3>
            ...
            {/* Card 2 */}
            <article className="bg-white dark:bg-slate-900 p-8 rounded-2xl border-2 border-gray-100 dark:border-slate-800 hover:border-violet-200 dark:hover:border-violet-700 hover:-translate-y-1 transition-all duration-300 hover:shadow-lg focus-within:border-violet-300 focus-within:shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-950 dark:to-purple-900 rounded-xl flex items-center justify-center mb-5" aria-hidden="true">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Find Logic Gaps</h3>
              <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            {/* Card 3 */}
            <article className="bg-white dark:bg-slate-900 p-8 rounded-2xl border-2 border-gray-100 dark:border-slate-800 hover:border-cyan-200 dark:hover:border-cyan-700 hover:-translate-y-1 transition-all duration-300 hover:shadow-lg focus-within:border-cyan-300 focus-within:shadow-lg">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-50 to-cyan-100 dark:from-cyan-950 dark:to-cyan-900 rounded-xl flex items-center justify-center mb-5" aria-hidden="true">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900 dark:text-white">Build Confidence</h3>
              <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
      ...
      <section id="how-it-works" className="py-16 md:py-24 px-4 relative overflow-hidden" aria-labelledby="how-it-works-heading">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-indigo-100/30 dark:bg-indigo-900/20 rounded-full blur-3xl pointer-events-none" />

        <div className="container mx-auto max-w-5xl relative z-10">
          {/* Section header */}
          <div className="text-center mb-16">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 rounded-full text-xs font-semibold tracking-wide mb-4">
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              3 Simple Steps
            </span>
            <h2 id="how-it-works-heading" className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-4">
              How It Works
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative group">
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-indigo-300 dark:hover:border-indigo-700 hover:-translate-y-2 transition-all duration-300 h-full flex flex-col">
                {/* Step indicator */}
                ...
                {/* Icon */}
                <div className="w-16 h-16 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-950 dark:to-indigo-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Paste Your Code</h3>
            ...
            {/* Step 2 */}
            <div className="relative group">
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-violet-300 dark:hover:border-violet-700 hover:-translate-y-2 transition-all duration-300 h-full flex flex-col">
                {/* Step indicator */}
                ...
                <div className="w-16 h-16 bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-950 dark:to-violet-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Answer Questions</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed flex-grow">
            ...
            {/* Step 3 */}
            <div className="relative group">
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-xl hover:border-purple-300 dark:hover:border-purple-700 hover:-translate-y-2 transition-all duration-300 h-full flex flex-col">
                {/* Step indicator */}
                ...
                <div className="w-16 h-16 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <svg className="w-8 h-8 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">See Your Gaps</h3>
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed flex-grow">
